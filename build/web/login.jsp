...
<html>
    ...
    <body>
        <h1 align="center"><b><font class="p" style="position:absolute;top:150px;z-index:5;left:120px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RESUME BUILDER</font></b></h1>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <tr>
                    ...
                    <td>
                        <input class="input" type="text" name="uid" placeholder="UserId" >
                    </td>
                </tr>
                <tr>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="input1" type="password" name="psw" placeholder="Password" >
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="input" type="submit" value="submit" name="submit" onclick="return validation();"/>
                    </td>
   ...
   <%-- <marquee>Banasthali University</marquee>--%>
